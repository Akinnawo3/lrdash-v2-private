...
const DateTypeFilter = ({
    toggled, handleToggle, dateType, handleDateTypeChange,
}) => {
    return <Dropdown direction="top" className="d-inline" isOpen={toggled} toggle={handleToggle}>
        <DropdownToggle caret className="btn-sm p-0 text-muted px-1 border-white" style={{ backgroundColor: "white", width: 120 }}>
            {dateType}
        </DropdownToggle>
        <DropdownMenu className="px-2" style={{ width: 230 }}>
            ...
            <FormGroup check className="mb-3">
                ...
                />
                <Label check className={`${dateType === "This week" && "gradient-text"}`} for="This week">
                    This week
                </Label>
            </FormGroup>
            <FormGroup check className="mb-3">
                ...
                />
                <Label check className={`${dateType === "This month" && "gradient-text"}`} for="This month">
                    This month
                </Label>
            </FormGroup>
            <FormGroup check className="mb-3">
                ...
                />
                <Label check className={`${dateType === "Last 6 months" && "gradient-text"}`} for="Last 6 months">
                    Last 6 months
                </Label>
            </FormGroup>
