    ...
    >
      ...
      <DropdownMenu className="px-2" style={{ width: 230 }}>
        ...
        <FormGroup check className="mb-3">
          ...
          <Label
            check
            className={`${dateType === "This week" && "gradient-text"}`}
            for={idPrefix + "This week"}
          >
            This week
          </Label>
        </FormGroup>
        <FormGroup check className="mb-3">
          ...
          <Label
            check
            className={`${dateType === "This month" && "gradient-text"}`}
            for={idPrefix + "This month"}
          >
            This month
          </Label>
        </FormGroup>
        <FormGroup check className="mb-3">
          ...
          <Label
            check
            className={`${dateType === "Last 6 months" && "gradient-text"}`}
            for={idPrefix + "Last 6 months"}
          >
            Last 6 months
          </Label>
        </FormGroup>
