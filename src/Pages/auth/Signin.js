        ...
        <Form onSubmit={handleSubmit}>
          ...
          <FormGroup>
            ...
            <InputGroup>
              ...
              >
                {passwordView === "password" ? (
                  <AiOutlineEye color="#04ADB2" />
                ) : (
                  <AiOutlineEyeInvisible color="#04ADB2" />
                )}
              </InputGroupText>
            </InputGroup>
          </FormGroup>
          <Button
            disabled={phoneNumber === "" || password === "" || postLoading}
            className="w-100 my-3 gradient-btn fw-bold"
          >
            {postLoading ? "LOADING..." : "SIGN IN"}
          </Button>

          <div className="fw-bold text-center my-3 gradient-text">
            Forgot Password?
          </div>
        </Form>
      </Card>
